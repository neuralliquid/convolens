...
| Tests, typecheck, build, package, version, ZIP           | CI plus `verify-package.mjs` validates aligned 1.0.20 metadata and exactly 13 non-empty safe ZIP entries                                        | Automated                  |
