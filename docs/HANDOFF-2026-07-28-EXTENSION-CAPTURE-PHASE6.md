...
- A disjoint zero-overlap window uses date-bearing WhatsApp metadata timestamps only when they place the entire incoming window clearly before or after the retained range. Date-less visible times, generated timestamps, equal or overlapping ranges, and unavailable ranges remain ambiguous instead of risking reversed chronology; an unresolved over-limit window is rejected intact.
...
- Packaged ZIP SHA-256: `C83431A9D103E754E25841C7AF9731E20340303D0BA101DA10EFAF93D9375D5B`.
