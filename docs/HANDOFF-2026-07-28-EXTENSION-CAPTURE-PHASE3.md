...
- Chrome extension Node tests: 49 passed, 0 failed, including shared-state, persistence-boundary, double-activation, navigation, retry-context and stale-collection cancellation, teardown, serialized auth-owner replacement, exact-credential auth-owner binding, auth-transition invalidation, in-flight logout truth, terminal-render deduplication, page retry, and popup-reopen source contracts.
...
- Packaged ZIP SHA-256: `C1565BB27D7D5AEBEE4B6978649381FE43B6A4B53851FBC44F07C9900D9AA2AC`.
